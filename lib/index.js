...
class RankCard {
	...
	/**
	 * Structure to be extended that holds data about the placement of an object.
	 ...
	 * * 'image'
	 * * 'colour'
	 * @typedef {'image' | 'colour'} BackgroundType
	 */
	 ...
	 * * 'gradient'
	 * * 'colour'
	 * @typedef {'gradient' | 'colour'} ProgressType
	 */
	 ...
	 * 
	 * @typedef {ProgressData & Placement} ProgressBar
	 */
	 ...
	 * 
	 * @typedef {AvatarData & Placement} Avatar
	 */
